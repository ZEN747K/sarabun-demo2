...
<script>
        ...
        $('#modalForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // === ตั้งค่าเริ่มต้นและ "ย้ายลายเซ็นเป็นอันที่ 2" ===
                    ...
                    // เรียงใหม่: ข้อความบน → รูปลายเซ็น → ข้อความล่าง
                    ...
                    signatureCoordinates = {
                        ...
                        bottomBox: {
                            startX: startX,
                            startY: startY + defaultTextHeight + gap + defaultImageHeight + gap,
                            endX: startX + defaultTextWidth,
    ...
    function onNextPageTable() {
        ...
        pageNumTalbe++; selectPageTable.value = pageNumTalbe; ajaxTable(pageNumTalbe);
    }
    ...
    $('#manager-send').click(function(e) {
        ...
        Swal.fire({
            ...
            $.ajax({
                ...
                data: { id: id, status: 14, position_id: position_id },
                dataType: "json",
                headers: { 'X-CSRF-TOKEN': '{{ csrf_token() }}' },
                success: function(response) {
                    if (response.status) {
    ...
    $('#send-save').click(function(e) {
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "post",
                url: "/book/send_to_save",
                data: { id: id, users_id: users_id, status: 14, position_id: position_id },
                dataType: "json",
                headers: { 'X-CSRF-TOKEN': '{{ csrf_token() }}' },
                success: function(response) {
                    if (response.status) {
    ...
    $(document).ready(function() {
        ...
        $('#reject-book').click(function (e) {
            ...
            Swal.fire({
                ...
                icon: "warning",
                input: 'textarea',
                inputPlaceholder: 'กรอกเหตุผลการปฏิเสธ55',
                showCancelButton: true,
